...
function AuthContent() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FAF7F0", display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ position: "fixed", left: 0, top: 0, bottom: 0, width: "42%", background: "linear-gradient(160deg, #2D4A2E 0%, #1A2E1B 100%)", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", padding: "3rem" }} className="hidden lg:flex">
      ...
      {/* Right — form */}
      <div style={{ marginLeft: "auto", width: "100%", maxWidth: 440, background: "#FFFFFF", borderRadius: "1.5rem", border: "1px solid #E5DDD0", padding: "2.5rem", boxShadow: "0 8px 40px rgba(31,46,31,0.08)" }}>
