...
const SETTINGS_ROWS: SettingRow[] = [
  ...
  { icon: Stethoscope, label: "Consultant portal", description: "Register or open your consultant dashboard", href: "/professional/consultant/register" },
  { icon: ChefHat, label: "Chef portal", description: "Register and publish Chef Specials", href: "/professional/chef/register" },
