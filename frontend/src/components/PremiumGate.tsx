...
export default function PremiumGate({ title = "Unlock Premium", description }: { title?: string, description?: string }) {
  ...
  return (
    <div className="nv-card p-6 sm:p-8 text-center space-y-4 relative overflow-hidden">
